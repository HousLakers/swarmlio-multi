...
private:
  ...
  bool simulateDrop(const string& topic_name);  // 丢包模拟: 按 sim_drop_rate 随机丢弃
  ...
  void offlineCheckTimerCallback(const ros::TimerEvent& e);
  ...
  ros::Timer drone_state_timer_, opt_timer_, swarm_traj_timer_, offline_check_timer_;
};
